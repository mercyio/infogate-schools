...
const AssignmentSubmissionSchema = new mongoose_1.Schema({
    assignment_id: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Assignment', required: true },
...
exports.default = mongoose_1.default.model('AssignmentSubmission', AssignmentSubmissionSchema);
